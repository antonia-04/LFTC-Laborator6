...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_lista_stmt = 17,                /* lista_stmt  */
  YYSYMBOL_stmt = 18,                      /* stmt  */
  YYSYMBOL_decl_stmt = 19,                 /* decl_stmt  */
  YYSYMBOL_read_stmt = 20,                 /* read_stmt  */
  YYSYMBOL_write_stmt = 21,                /* write_stmt  */
  YYSYMBOL_assign_stmt = 22,               /* assign_stmt  */
...
{
       0,    88,    88,    90,    90,    92,    92,    92,    92,    94,
     102,   117,   132,   146,   147,   154,   163,   164,   173,   174,
     180
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "READ", "WRITE",
  "ARROW", "ID", "NUMBER", "';'", "'+'", "'-'", "'*'", "'('", "')'",
  "$accept", "program", "lista_stmt", "stmt", "decl_stmt", "read_stmt",
  "write_stmt", "assign_stmt", "expr", "term", "factor", YY_NULLPTR
};
...
{
       0,    -5,     9,    10,    12,    19,   -20,     0,   -20,   -20,
     -20,   -20,    11,    13,    14,    -7,   -20,   -20,   -20,   -20,
     -20,   -20,   -20,    -7,     4,    15,   -20,    -2,   -20,    -7,
      -7,    -7,   -20,    15,    15,   -20
};
...
{
       0,     0,     0,     0,     0,     0,     2,     3,     5,     6,
       7,     8,     0,     0,     0,     0,     1,     4,     9,    10,
      11,    19,    18,     0,     0,    13,    16,     0,    12,     0,
       0,     0,    20,    14,    15,    17
};
...
{
      21,    22,    12,     1,     2,     3,    23,     4,    29,    30,
      33,    34,    32,    28,    29,    30,    13,    14,    15,    16,
      18,    35,    19,    20,    17,    27,     0,    31
};

static const yytype_int8 yycheck[] =
{
       7,     8,     7,     3,     4,     5,    13,     7,    10,    11,
      29,    30,    14,     9,    10,    11,     7,     7,     6,     0,
       9,    31,     9,     9,     7,    23,    -1,    12
};
...
{
       0,     3,     4,     5,     7,    16,    17,    18,    19,    20,
      21,    22,     7,     7,     7,     6,     0,    17,     9,     9,
       9,     7,     8,    13,    23,    24,    25,    23,     9,    10,
      11,    12,    14,    24,    24,    25
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: lista_stmt  */
#line 88 "analizor.y"
                     { scrie_asm_complet(); }
#line 1170 "parser.tab.c"
    break;

  case 9: /* decl_stmt: INT ID ';'  */
#line 95 "analizor.y"
{
    std::string name((yyvsp[-1].sval));
    free((yyvsp[-1].sval));
...
#line 1214 "parser.tab.c"
  ...
  case 12: /* assign_stmt: ID ARROW expr ';'  */
#line 133 "analizor.y"
{
    std::string name((yyvsp[-3].sval));
    free((yyvsp[-3].sval));
    cere_declarata(name);
...
#line 173 "analizor.y"
                { linie("push dword " + std::to_string((yyvsp[0].ival))); }
